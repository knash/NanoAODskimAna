...
def build_allhad_model(TT_SF_local=1.0,ltype="Mu"):
    files = ["ThetaFile_ttfit_Mu2018_Pt450to500_CNN0p9.root"]
...
posttext = "ThetaFile_ttfit_Mu2018_Pt450to500_CNN0p9.root".replace("ThetaFile_ttfit_PSET_default","").replace(".root","").replace("Mu","").replace("Ele","")
